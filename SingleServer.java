...
public class SingleServer {
    ...
    private static int next_event_type, num_customers_delayed, num_delays_required, num_events, num_in_q, server_status;
...
// check to see whether the event list is empty
        if (next_event_type == 0) {
            ...
            System.out.println("Event list emepty at time " + time);
        }
//the event list is not empty, so advance the simulation clock
    ...
    public static void arrive() {
        ...
        time_next_event[1] = time + exponential(mean_interArrival);
        // check server status if its busy
...
statistics. */
    ...
    public static void main(String[] args) {
        num_events = 2;  //Specify number of events for the timing function.
        ...
        report(); //Invoke the report generator and end of simulation.
    }
}
